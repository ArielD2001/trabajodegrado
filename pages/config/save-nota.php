...
$p18m1 = $_POST['p18m1'];
$total2 = $_POST['total2'];
$recomendaciones2 = $_POST['recomendaciones2'];
...
$p29m1 = $_POST['p29m1'];
$total2 = $_POST['total2'];
$recomendaciones3 = $_POST['recomendaciones3'];
$p30m1 = $_POST['p30m1'];
$p31m1 = $_POST['p31m1'];
$suma3 = $_POST['suma3'];
$p32m1 = $_POST['p32m1'];
...
$consulta= "SELECT * FROM preguntas1 WHERE id_estudiante = ?";
...
if($filas == 0){
    $consultai = "INSERT INTO preguntas1(id_estudiante, suma1, p1m1, p2m1, p3m1, p4m1, p5m1, p6m1, p7m1, p8m1, total1,  
    ...
    total4, recomendaciones4, subtotal2 )";
