...
$total1 = $_POST['total1']; $p10m4 = $_POST['p10m4'];   $p11m4 = $_POST['p11m4'];   
$p12m4 = $_POST['p12m4'];   $p13m4 = $_POST['p13m4'];   $p14m4 = $_POST['p14m4'];   
$p15m4 = $_POST['p15m4'];   $p16m4 = $_POST['p16m4'];   $p17m4 = $_POST['p17m4'];   
$p18m4 = $_POST['p18m4'];   $p20m4 = $_POST['p20m4'];   $p21m4 = $_POST['p21m4'];   
$p22m4 = $_POST['p22m4'];   $suma2 = $_POST['suma2'];   $p23m4 = $_POST['p23m4'];   
$p24m4 = $_POST['p24m4'];   $p25m4 = $_POST['p25m4'];   $p26m4 = $_POST['p26m4'];   
$p27m4 = $_POST['p27m4'];   $p28m4 = $_POST['p28m4'];   $p29m4 = $_POST['p29m4'];   
$total3 = $_POST['total3']; $p30m4 = $_POST['p30m4'];   $p31m4 = $_POST['p31m4'];   
...
$total4 = $_POST['total4']; $p19m4 = $_POST['p19m4'];   $total2 = $_POST['total2'];
$total5 = $_POST['total5']; $total6 = $_POST['total6']; $p9m4 = $_POST['p9m4'];     
...
if($filas < 1){
    ...
    subtotal1, p19m4, p20m4, p21m4, p22m4, suma2, p23m4, p24m4, p25m4, p26m4, p27m4, p28m4, p29m4, total3, recomendaciones3, 
    p30m4, p31m4, suma3, p32m4, p33m4, p34m4, p35m4, p36m4, p37m4, p38m4, p39m4, p40m4, p41m4, p42m4, p43m4, p44m4, p45m4, 
    total4, recomendaciones4, subtotal2, p46m4, p47m4, p48m4, p49m4, p50m4, p51m4, p52m4, p53m4, p54m4, p55m4, p56m4, p57m4, total5, total6, subtotal3, subtotal4, recomendaciones5, recomendaciones6 )VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    subtotal1, p19m4, p20m4, p21m4, p22m4, suma2, p23m4, p24m4, p25m4, p26m4, p27m4, p28m4, p29m4, total3, recomendaciones3, 
    p30m4, p31m4, suma3, p32m4, p33m4, p34m4, p35m4, p36m4, p37m4, p38m4, p39m4, p40m4, p41m4, p42m4, p43m4, p44m4, p45m4, 
    total4, recomendaciones4, subtotal2, p46m4, p47m4, p48m4, p49m4, p50m4, p51m4, p52m4, p53m4, p54m4, p55m4, p56m4, p57m4, p58m4, total5, total6, subtotal3, subtotal4, recomendaciones5, recomendaciones6 )VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
