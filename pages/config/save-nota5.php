...
if($total == 'NaN'){
    ...
    $consulta= "SELECT * FROM preguntasm5 WHERE id_estudiante = ? AND rotacion = ?";
...
if($filas < 1){
    ...
    $delete = "DELETE  FROM preguntasm5 WHERE id_estudiante = ? AND rotacion = ?";
