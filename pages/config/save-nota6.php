...
if($total == 'NaN'){
    ...
    $consulta= "SELECT * FROM preguntasm6 WHERE id_estudiante = ? AND rotacion";
...
if($filas < 1){
    ...
    $delete = "DELETE  FROM preguntasm6 WHERE id_estudiante = ? AND rotacion = ?";
