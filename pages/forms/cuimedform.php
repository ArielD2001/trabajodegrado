...
<link rel="stylesheet" href="sweetalert2.min.css">
    <title>Cuidado medico quirurgico - <?php echo $estudiante['Nombre'] ?> </title>
</head>
<body>
...
<div class="contenedor">
    ...
    <div class="competencias flex">
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p1m3'] : '0.00'); ?>" type="text" class="input  subA1 border no-top no-left padding-5" id="A-1-2" name="p1m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p2m3'] : '0.00'); ?>" type="text" class="input border subA1  no-top no-left padding-5" id="A-1-3" name="p2m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p3m3'] : '0.00'); ?>" type="text" class="input border subA1  no-top no-left padding-5" id="A-1-4" name="p3m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p4m3'] : '0.00'); ?>" type="text" class="input border  subA1 no-top no-left padding-5" id="A-1-5" name="p4m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p5m3'] : '0.00'); ?>" type="text" class="input border campoA1 no-top no-left padding-5" id="A-1-6" name="p5m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p6m3'] : '0.00'); ?>" type="text" class="input border campoA1 no-top no-left padding-5" id="A-1-7" name="p6m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p7m3'] : '0.00'); ?>" type="text" class="input border campoA1 no-top no-left padding-5" id="A-1-8" name="p7m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p8m3'] : '0.00'); ?>" type="text" class="input border campoA1 no-top no-left padding-5" id="A-1-9" name="p8m3">
                </div>
            ...
            <textarea class="rec border no-top no-left padding-5 " name="recomendaciones1" style="font-size:15px ; text-transform:capitalize"><?php echo ($cnotas > 0 ? $notas['recomendaciones1'] : 'Sin recomendaciones'); ?></textarea>
        </div>
        ...
        <div class="pregs responsabilidad">
            <div class="items fs-14">
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p9m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p9m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p10m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p10m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p11m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p11m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p12m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p12m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>5.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p13m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p13m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p14m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p14m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p15m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p15m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p16m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p16m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p17m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p17m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p18m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p18m3">
                </div>
            ...
            <textarea class="rec border no-top no-left padding-5 " name="recomendaciones2" style="font-size:15px ; text-transform:capitalize"><?php echo ($cnotas > 0 ? $notas['recomendaciones2'] : 'Sin recomendaciones'); ?> </textarea>
        </div>
        <div class="total flex  " style="width: 100%">
            ...
            <input class="total1 border bold no-top no-left padding-5" readonly name="subtotal1"  value="<?php echo ($cnotas > 0 ? $notas['subtotal1'] : '0.00'); ?>" style="text-align: center; width:30% ;background:teal;color:white" id="subtotalA">
        </div>
    </div>
    ...
    <div class="competencias flex">
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p19m3'] : '0.00'); ?>" type="text" class="input border campoB1 no-top no-left padding-5" name="p19m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p20m3'] : '0.00'); ?>" type="text" class="input border campoB1 no-top no-left padding-5" name="p20m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p21m3'] : '0.00'); ?>" type="text" class="input border campoB1 no-top no-left padding-5" name="p21m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p22m3'] : '0.00'); ?>" type="text" class="input border campoB1 no-top no-left padding-5" name="p22m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>5.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p24m3'] : '0.00'); ?>" type="text" class="input campoB1 border no-top no-left padding-5" name="p24m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>6.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p25m3'] : '0.00'); ?>" type="text" class="input border campoB1 no-top no-left padding-5" name="p25m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input readonly value="<?php echo ($cnotas > 0 ? $notas['total3'] : '0.00'); ?>" type="text" id="totalB1" name="total3" class="input border no-top no-left padding-5" style="background-color: yellow">
                </div>
            </div>
            <textarea class="rec border no-top no-left padding-5 " name="recomendaciones3" style="font-size:15px ; text-transform:capitalize"><?php echo ($cnotas > 0 ? $notas['recomendaciones3'] : 'Sin recomendaciones'); ?></textarea>
        </div>
        <p class="padding-10 border no-top" style="width: 100%"></p>
        ...
        <div class="pregs responsabilidad">
            <div class="items fs-14">
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p26m3'] : '0.00'); ?>" type="text" class="input border campoB2 no-top no-left padding-5" name="p26m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p27m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p27m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p28m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p28m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p29m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p29m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>5.</b></span>
                    ...
                    <input  value="<?php echo ($cnotas > 0 ? $notas['p30m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p30m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p31m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p31m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>7.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p32m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p32m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>8.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p33m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p33m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>9.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p34m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p34m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>10.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p35m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p35m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p36m3'] : '0.00'); ?>" type="text" class="input border campoB2 no-top no-left padding-5" name="p36m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p37m3'] : '0.00'); ?>" type="text" class="input border campoB2 no-top no-left padding-5" name="p37m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p38m3'] : '0.00'); ?>" type="text" class="input border campoB2 no-top no-left padding-5" name="p38m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p39m3'] : '0.00'); ?>" type="text" class="input border campoB2 no-top no-left padding-5" name="p39m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p40m3'] : '0.00'); ?>" type="text" class="input border campoB2 no-top no-left padding-5" name="p40m3">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p41m3'] : '0.00'); ?>" type="text" class="input border campoB2 no-top no-left padding-5" name="p41m3">
                </div>
                <div class="item   flex">
                    ...
                    <input readonly value="<?php echo ($cnotas > 0 ? $notas['total4'] : '0.00'); ?>" id="totalB2" type="text" name="total4" class="input border no-top no-left padding-5" style="background-color: yellow">
                </div>
            </div>
        ...
        <div class="total flex  " style="width: 100%">
            ...
            <input value="<?php echo ($cnotas > 0 ? $notas['subtotal2'] : '0.00'); ?>" readonly name="subtotal2" class="total1 border bold no-top no-left padding-5" id="subtotalB" style="text-align: center; width:30% ;background:teal;color:white">
        </div>
    </div>
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p42m3'] : '0.00'); ?>" type="text" class="input campoC border no-top no-left padding-5" id="A-1-2" name="p42m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input readonly value="<?php echo ($cnotas > 0 ? $notas['total5'] : '0.00'); ?>" type="text" name="total5" id="totalC" class="input border no-top no-left padding-5" style="background-color: yellow">
                </div>
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p43m3'] : '0.00'); ?>" type="text" class="input  campoD border no-top no-left padding-5" id="A-1-2" name="p43m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p44m3'] : '0.00'); ?>" type="text" class="input border campoD  no-top no-left padding-5" id="A-1-3" name="p44m3">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input readonly value="<?php echo ($cnotas > 0 ? $notas['total6'] : '0.00'); ?>" type="text" name="total6" id="totalD" class="input border no-top no-left padding-5" style="background-color: yellow">
                </div>
            </div>  
    ...
    <div class="total flex  " style="width: 100%">
        ...
        <input value="<?php echo ($cnotas > 0 ? $notas['subtotal4'] : '0.00'); ?>" readonly name="subtotal4" class="total1 border bold no-top no-left padding-5" id="subtotalD" style="text-align: center; width:30% ;background:teal;color:white">
    </div>
    ...
    <div class="total flex border no-left  " style="width: 100%">
        ...
        <input value="<?php echo ($cnotas > 0 ? $notat['nota'] : '0.00'); ?>" readonly name="totalgeneral" class="total1 border bold no-top no-left padding-5" id="totalF" style="text-align: center; width:30% ;background:teal;color:white">
    </div>
