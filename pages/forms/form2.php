...
<div class="contenedor">
    ...
    <div class="competencias flex">
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                ...
                <div class="item   flex">
                    ...
                    <input readonly value="0.00" type="text" class="input border no-top no-left padding-5" id="totalB1" style="background-color: yellow">
                </div>
            </div>
            <textarea class="rec border no-top no-left padding-5 " style="font-size:15px ; text-transform:capitalize"></textarea>
        </div>
        ...
        <div class="pregs responsabilidad">
            <div class="items fs-14">
                ...
                <div class="item   flex">
                    ...
                    <input readonly placeholder="0.00" id="pregunta5" type="text" class="input campoB2 border no-top no-left padding-5" style="background-color: #FCABC4;">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>a.</b></span>
                ...
                <div class="item   flex">
                    ...
                    <input readonly placeholder="0.00" id="pregunta10" type="text" class="input campoB2 border no-top no-left padding-5" style="background-color: #FCABC4;">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>a.</b></span>
                    ...
                    <input placeholder="0.00" type="text" class="input subB2a border no-top no-left padding-5">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>b.</b></span>
        ...
        <div class="total flex  " style="width: 100%">
            ...
            <p id="subtotalB" class="total1 border bold no-top no-left padding-5" style="text-align: center; width:30% ;background:teal;color:white">0.00</p>
        </div>
    </div>
