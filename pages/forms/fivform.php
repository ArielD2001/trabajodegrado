...
<form method="post" id="fivform">
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p1m3'] : '0.00'); ?>" type="text" class="input  subA1 border no-top no-left padding-5" id="A-1-2" name="p1m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p2m3'] : '0.00'); ?>" type="text" class="input border subA1  no-top no-left padding-5" id="A-1-3" name="p2m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p3m3'] : '0.00'); ?>" type="text" class="input border subA1  no-top no-left padding-5" id="A-1-4" name="p3m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p4m3'] : '0.00'); ?>" type="text" class="input border  subA1 no-top no-left padding-5" id="A-1-5" name="p4m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p5m3'] : '0.00'); ?>" type="text" class="input border campoA1 no-top no-left padding-5" id="A-1-6" name="p5m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p6m3'] : '0.00'); ?>" type="text" class="input border campoA1 no-top no-left padding-5" id="A-1-7" name="p6m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p7m3'] : '0.00'); ?>" type="text" class="input border campoA1 no-top no-left padding-5" id="A-1-8" name="p7m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p8m3'] : '0.00'); ?>" type="text" class="input border campoA1 no-top no-left padding-5" id="A-1-9" name="p8m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input readonly value="<?php echo ($cnotas > 0 ? $notas['total1'] : '0.00'); ?>" type="text" id="totalA1" name="total1" class="input border no-top no-left padding-5" style="background-color: yellow">
                </div>
            </div>
        ...
        <div class="pregs responsabilidad">
            <div class="items fs-14">
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p9m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p9m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p10m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p10m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p11m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p11m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p12m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p12m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>5.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p13m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5 " name="p13m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p14m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p14m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p15m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p15m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p16m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p16m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p17m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p17m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p18m3'] : '0.00'); ?>" type="text" class="input campoA2 border no-top no-left padding-5" name="p18m8">
                </div>
            ...
            <textarea class="rec border no-top no-left padding-5 " name="recomendaciones2" style="font-size:15px ; text-transform:capitalize"><?php echo ($cnotas > 0 ? $notas['recomendaciones2'] : '0.00'); ?></textarea>
        </div>
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p19m3'] : '0.00'); ?>" type="text" class="input campoB1 border no-top no-left padding-5"  name="p19m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p20m3'] : '0.00'); ?>" type="text" class="input campoB1 border no-top no-left padding-5" name="p20m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p21m3'] : '0.00'); ?>" type="text" class="input campoB1 border no-top no-left padding-5" name="p21m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p22m3'] : '0.00'); ?>" type="text" class="input campoB1 border no-top no-left padding-5" name="p22m8">
                </div>
        ...
        <div class="pregs responsabilidad">
            <div class="items fs-14">
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p24m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p24m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p25m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p25m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input  value="<?php echo ($cnotas > 0 ? $notas['p26m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p26m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p27m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p27m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>5.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p28m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p28m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>6.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p29m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p29m8">
                </div>
                <div class="item   flex">
                    <div class="pregunta border no-top padding-5">
                        <span class="numero "><b>7.</b></span>
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p30m3'] : '0.00'); ?>" type="text" class="input campoB2 border no-top no-left padding-5" name="p30m8">
                </div>
                ...
                <div class="item   flex">
                    ...
                    <input readonly value="<?php echo ($cnotas > 0 ? $notas['total4'] : '0.00'); ?>" type="text" id="totalB2" name="total4" class="input border no-top no-left padding-5" style="background-color: yellow">
                </div>
            </div>
            <textarea class="rec border no-top no-left padding-5 " name="recomendaciones4" style="font-size:15px ; text-transform:capitalize"><?php echo ($cnotas > 0 ? $notas['recomendaciones4'] : ''); ?></textarea>
        </div>
        <div class="total flex  " style="width: 100%">
            ...
            <input name="subtotal2" value="<?php echo ($cnotas > 0 ? $notas['subtotal2'] : '0.00'); ?>" readonly class="total1 border bold no-top no-left padding-5" id="subtotalB" style="text-align: center; width:30% ;background:teal;color:white">
        </div>
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p31m3'] : '0.00'); ?>" type="text" class="input  campoC border no-top no-left padding-5" id="A-1-2" name="p31m8">
                    
                </div>
                
               
            </div>
            <textarea class="rec border no-top no-left padding-5 " name="recomendaciones5" style="font-size:15px ; text-transform:capitalize" name="recomendaciones5"><?php echo ($cnotas > 0 ? $notas['recomendaciones5'] : ''); ?></textarea>
    </div>
    <div class="total flex  " style="width: 100%">
        ...
        <div class="pregs relaciones">
            <div class="items fs-14">
                ...
                <div class="item   flex">
                    ...
                    <input value="<?php echo ($cnotas > 0 ? $notas['p32m3'] : '0.00'); ?>" type="text" class="input  campoD border no-top no-left padding-5" id="A-1-2" name="p32m8">
                </div>
    ...
    <div class="total flex border no-left  " style="width: 100%">
        ...
        <input value="<?php echo ($cnotas > 0 ? $notat['nota'] : '0.00'); ?>" name="totalgeneral" class="total1 border bold no-top no-left padding-5" id="totalF" style="text-align: center; width:30% ;background:teal;color:white" readonly>
    </div>
